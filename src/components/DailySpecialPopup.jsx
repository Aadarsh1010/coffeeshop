  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        // This is now a single fixed flex container that centers the
        // modal both vertically and horizontally on every screen size.
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          ...
          className="fixed inset-0 z-[100] flex items-center justify-center
                     p-4 sm:p-6
                     bg-coffee-900/75 backdrop-blur-sm overflow-y-auto"
        >
          {/* ──────────── MODAL CARD ──────────── */}
          <motion.div
            ...
            // Clicking the card itself should NOT close the modal
            onClick={(e) => e.stopPropagation()}
            className="relative w-full max-w-md sm:max-w-lg my-auto
          ...
          >
            ...
            <div className="relative h-48 sm:h-56 overflow-hidden">
              ...
              <button
                onClick={close}
                aria-label="Close daily special"
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="px-5 py-3 rounded-full text-coffee-700 dark:text-cream-200/70
                             hover:text-coffee-900 dark:hover:text-cream-50
