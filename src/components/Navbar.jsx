...
const drawer = {
  closed: { x: '100%' },
  open:   { x: 0, transition: { type: 'tween', ease: [0.22, 1, 0.36, 1], duration: 0.45 } },
}
const drawerStagger = {
...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      ...
      {/* Main nav — CSS-driven transitions for 60fps performance */}
      <div
          ...
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed top-0 right-0 bottom-0 z-50 w-[88%] max-w-sm
                         bg-coffee-900 border-l border-coffee-800 shadow-2xl flex flex-col"
            >
              <div className="flex items-center justify-between p-4 sm:p-5 border-b border-coffee-800">
              ...
              >
                ...
                <motion.li variants={drawerItem} className="pt-4">
                  <Link
                    to="/menu"
                    onClick={() => setOpen(false)}
              ...
              <motion.div
                ...
                animate="open"
                exit="closed"
                className="p-4 sm:p-5 border-t border-coffee-800 space-y-3 text-sm text-cream-200/80"
              >
                <a href="tel:+15552347891"
